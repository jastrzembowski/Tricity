...
function Privacy(props) {
  return (
    <div>
      <h1>Privacy Policy for TriCity Solution</h1>
      <p>
        At TriCity Solution, accessible from www.tricitysolution.pl, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        TriCity Solution and how we use it.
      </p>
      ...
      <p>
        TriCity Solution legal basis for collecting and using the personal
      ...
      <ul>
        <li>TriCity Solution needs to perform a contract with you</li>
        <li>You have given TriCity Solution permission to do so</li>
        <li>
          Processing your personal information is in TriCity Solution legitimate
          interests
        </li>
        <li>TriCity Solution needs to comply with the law</li>
      </ul>

      <p>
        TriCity Solution will retain your personal information only for as long
      ...
      <p>
        TriCity Solution follows a standard procedure of using log files. These
      ...
      <p>
        ...
        advertising partners of TriCity Solution.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on TriCity Solution, which are sent
      ...
      <p>
        Note that TriCity Solution has no access to or control over these
      ...
      <p>
        TriCity Solution's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        TriCity Solution does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        to the information that they shared and/or collect in TriCity Solution.
